            ...
            authContainer.innerHTML = `
                <button onclick="AccountSystem.loginWithGoogle()" style="border-color: #a83232; background: rgba(168, 50, 50, 0.15); font-size: 14px; padding: 10px; display: flex; align-items: center; justify-content: center; gap: 8px; margin-bottom: 15px;">
                    <svg style="width: 16px; height: 16px; fill: currentColor;" viewBox="0 0 24 24">
                        <path d="M21.35 11.1h-9.17v2.73h6.51c-.33 1.56-1.56 2.95-3.24 3.75v3.08h5.21c3.05-2.81 4.81-6.95 4.81-11.82 0-.64-.06-1.25-.12-1.74zM12.18 21.4c2.75 0 5.06-.91 6.75-2.46l-5.21-3.08c-1.44.96-3.29 1.54-5.21 1.54-4.01 0-7.4-2.71-8.61-6.36H.99v3.19C2.97 18.06 7.22 21.4 12.18 21.4zM3.57 11.04c-.31-.96-.49-1.98-.49-3.04s.18-2.08.49-3.04V1.77H.99C.36 3.04 0 4.48 0 6s.36 2.96.99 4.23l2.58-3.19zM12.18 3.4c1.89 0 3.59.65 4.93 1.93l3.69-3.69C18.57.91 15.56.2 12.18.2 7.22.2 2.97 3.54.99 7.31l3.57 3.04c1.21-3.65 4.6-6.35 8.61-6.35z"/>
                    </svg>
                    Sign In with Google
                </button>
            `;
